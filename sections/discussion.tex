...
The LLM itself acts as the memory controller in 54\% of systems.
Evaluation is centred on SWE-bench Verified, which appears in 67\% of
...
no-memory baseline (\autoref{tab:performance}), with a median gain of
...
performance (\autoref{tab:degradation}).
...
selected studies, as detailed in \autoref{sec:extraction}; (iii) factual
