...
with a benchmark, though comparability is limited by heterogeneous
model choices and by differences in framework and experimental setup.
...
The most critical gap is the absence of direct comparisons.
...
model backbone, and an integrated per-task cost analysis.
