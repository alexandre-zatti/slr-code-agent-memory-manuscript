...
% =====================================================================
% Footnotes — small gap after mark to prevent bounding-box overlap
% in pdftotext analysis (visual-qa.sh Layer 2)
% =====================================================================
...
% Evita cabeçalhos de seção órfãos no final da página
...
% Relaxar constraints de floats para evitar páginas dedicadas a uma
% única figura com excesso de espaço em branco.  Permite que figuras
% maiores fiquem no topo de páginas de texto, com texto fluindo abaixo.
