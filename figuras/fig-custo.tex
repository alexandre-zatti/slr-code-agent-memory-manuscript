% fig:custo — Bimodality diagram: cost impact of memory
% Left side: substitution (cost reduction). Right side: addition (cost increase).
...
% --- Lado esquerdo: sistemas que reduzem custo ---
...
% --- Lado direito: sistemas que aumentam custo ---
% Centralizado verticalmente no span do lado esquerdo (-1 a -7)
% Centro = -4.0; 4 itens com espaçamento 1.0 → -2.5 a -5.5
...
\node[system box=negLoss] at (3.5, -5.5)
  {RepoMem: custo $\uparrow$ em difíceis};
