...
Em baselines já fortes (acima de 65\%), os ganhos marginais situam-se
entre +2 e +9~pp, sugerindo rendimentos decrescentes à medida que o
...
abertos~\cite{srivastava2025memorygraft}; e incompatibilidade de
infraestrutura entre o harness de avaliação e o mecanismo de
memória~\cite{joshi2025swebenchcl}.
...
\citeonline{guo2026eet}, com heurística de terminação, obtêm resultados
comparáveis a sistemas multi-tier como
KAPSO~\cite{nadafian2026kapso} e GCC~\cite{wu2025gcc} em seus
